require 'erb'
require 'resolv'
require 'wake-azure/azure/scp'
require 'wake-azure/azure/provisioning_state_poller'
require 'wake-azure/azure/setup/dockerable'
require 'wake-azure/azure/setup/setupable'
